...
log_file_path = "program_synthesis/logs/utensil_placement.json"
...
logs = {
    ...
    5: {
        "ActionAPI": "",
        "Instruction": "Pick up the pair of chopsticks with your right hand.",
        "Time_Taken": 0,
        "Completeness": False
    },
    6: {
    ...
    8: {
        "ActionAPI": "",
        "Instruction": "Pick up the fork with your right hand.",
        "Time_Taken": 0,
        "Completeness": False
    },
    9: {
...
behavior Instruction():
    ...
    # ---------- Instruction 5 ----------
    take SpeakAction("Pick up the pair of chopsticks with your right hand.")
    take DoneAction()
    ...
    # ---------- Instruction 8 ----------
    take SpeakAction("Pick up the fork with your right hand.")
    take DoneAction()
