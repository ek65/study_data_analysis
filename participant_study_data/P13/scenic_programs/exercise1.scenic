...
# Instruction logs
logs = {
    0: {"ActionAPI": "", "Instruction": "Sit at the table with orange, blue, and green cubes in front of you.", "Time_Taken": 0, "Completeness": False},
    1: {"ActionAPI": "", "Instruction": "Use your right hand to pick up the orange cube.", "Time_Taken": 0, "Completeness": False},
    2: {"ActionAPI": "", "Instruction": "Place the orange cube on the table as the base.", "Time_Taken": 0, "Completeness": False},
    3: {"ActionAPI": "", "Instruction": "Use your right hand to pick up the blue cube.", "Time_Taken": 0, "Completeness": False},
    4: {"ActionAPI": "", "Instruction": "Stack the blue cube on top of the orange cube.", "Time_Taken": 0, "Completeness": False},
    5: {"ActionAPI": "", "Instruction": "Use your right hand to pick up the green cube.", "Time_Taken": 0, "Completeness": False},
    6: {"ActionAPI": "", "Instruction": "Stack the green cube on top of the blue cube.", "Time_Taken": 0, "Completeness": False},
    7: {"ActionAPI": "", "Instruction": "Grab the green cube with your right hand.", "Time_Taken": 0, "Completeness": False},
    8: {"ActionAPI": "", "Instruction": "Place the green cube on the table.", "Time_Taken": 0, "Completeness": False},
    9: {"ActionAPI": "", "Instruction": "Grab the blue cube with your right hand.", "Time_Taken": 0, "Completeness": False},
    10: {"ActionAPI": "", "Instruction": "Place the blue cube on the table", "Time_Taken": 0, "Completeness": False},
    11: {"ActionAPI": "", "Instruction": "Rest your right hand.", "Time_Taken": 0, "Completeness": False}
}
...
behavior Instruction():
    ...
    # ---------- Instruction 3 ----------
    take SpeakAction("Use your right hand to pick up the blue cube.")
    take DoneAction()
    ...
    # ---------- Instruction 5 ----------
    take SpeakAction("Use your right hand to pick up the green cube.")
    take DoneAction()
