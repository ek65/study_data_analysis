...
log_file_path = "program_synthesis/logs/post_it_reach_exercise.json"
...
logs = {
    0: {
        "ActionAPI": "",
        "Instruction": "Sit at a table with a pink and a yellow post-its in front of you.",
        "Time_Taken": 0,
        "Completeness": False
    },
    1: {
    ...
    2: {
        "ActionAPI": "",
        "Instruction": "With your left hand, place the pink post-it at the edge of the table away from you.",
        "Time_Taken": 0,
        "Completeness": False
    },
    3: {
        "ActionAPI": "",
        "Instruction": "With your left hand, place the yellow post-it at the edge of the table right in front of you.",
        "Time_Taken": 0,
        "Completeness": False
    },
    4: {
    ...
    5: {
        "ActionAPI": "",
        "Instruction": "Reach forward with your right hand to touch the pink post-it by extending your elbow. Use your left hand to assist in moving right hand if needed.",
        "Time_Taken": 0,
        "Completeness": False
    },
    6: {
        "ActionAPI": "",
        "Instruction": "Return your hand again to the yellow post-it.",
        "Time_Taken": 0,
        "Completeness": False
    },
    7: {
    ...
    9: {
        "ActionAPI": "",
        "Instruction": "Rest your hand on the table.",
        "Time_Taken": 0,
        "Completeness": False
    }
}
...
behavior Instruction():
    ...
    # ---------- Instruction 0 ----------
    take SpeakAction("Sit at a table with a pink and a yellow post-its in front of you.")
    take DoneAction()
    ...
    # ---------- Instruction 2 ----------
    take SpeakAction("With your left hand, place the pink post-it at the edge of the table away from you.")
    take DoneAction()
    ...
    # ---------- Instruction 3 ----------
    take SpeakAction("With your left hand, place the yellow post-it at the edge of the table right in front of you.")
    take DoneAction()
    ...
    # ---------- Instruction 5 ----------
    take SpeakAction("Reach forward with your right hand to touch the pink post-it by extending your elbow. Use your left hand to assist in moving right hand if needed.")
    take DoneAction()
    ...
    # ---------- Instruction 6 ----------
    take SpeakAction("Return your hand again to the yellow post-it.")
    take DoneAction()
    ...
    # ---------- Instruction 9 ----------
    take SpeakAction("Rest your hand on the table.")
    take DoneAction()
