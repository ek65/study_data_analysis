...
log_file_path = "program_synthesis/logs/forearm_rotation_with_scoop.json"
...
behavior Instruction():
    ...
    start_time, count = time.time(), 0
    take SendImageAndTextRequestAction(f"Current Instruction: Hold the scoop with your right hand. Prior Instructions: {[logs[i]['Instruction'] for i in range(log_idx)]}")
    take DoneAction()
